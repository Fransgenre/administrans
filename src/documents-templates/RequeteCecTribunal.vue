...
<template>
  <div class="requete">
    <p class="text--right">
      À Mesdames et Messieurs les Président et Juges de la Chambre du Conseil du 
    ...
    <p>  
      Le législateur a en outre pris la peine d’indiquer directement dans la loi que :
    </p>
    <blockquote>
      <p>
        « Le fait de ne pas avoir subi des traitements médicaux, une opération chirurgicale ou une stérilisation ne peut motiver le refus de faire droit à la demande. »
    ...
    <blockquote>
      <p>
        « L’emploi, par le législateur, des termes « principaux de ces faits … peuvent être », permet de considérer que l’énumération de ces faits et circonstances n’est ni exhaustives, ni cumulatives. » 
      </p>
    </blockquote>
    <p>
    ...
    <blockquote>
      « La réunion d’une série de faits énumérés à titre indicatif permet selon la méthode du faisceau d’indices »
    </blockquote>
    <p>
      Lors de la commission des lois du mercredi 29 juin 2016 consacrée au même projet de loi, Pascale CROZON, alors députée, rappelle « par ailleurs que ces faits ne sont pas cumulatifs ». Enfin, lors de la 1ère séance plénière du 12 juillet 2016 à l’Assemblée Nationale, le député Sergio CORONADO ajoute :
    </p>
    <blockquote>
      <p>
        « Les éléments de preuve pouvant être apportés par tous moyens par la personne, et énumérés dans le même article, ne peuvent être cumulatifs ».
      </p>
    </blockquote>
